...
class HomeWorkTest {
  ...
  open class Rectangle(val width: Int, val height: Int) : Figure {
    ...
    override fun hashCode() = height.hashCode() + width.hashCode()
    override fun equals(other: Any?): Boolean {
      val otherRectangle = other as? Rectangle
  ...
  fun diffArea(figure1: Figure, figure2: Figure) = abs(figure1.area() - figure2.area())
}
