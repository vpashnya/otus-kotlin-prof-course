...
fun ApplicationConfig.createIPStreamConsumer(): KafkaConsumer<String, String> {
...
fun ApplicationConfig.createIPStreamProducer(): KafkaProducer<String, String> {
  val props = Properties().apply {
...
fun ApplicationConfig.createIPStreamTopicPair() = TopicPair(
